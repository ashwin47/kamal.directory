module ApplicationHelper
  ...
  def nav_link(text, path)
    class_name = current_page?(path) ? "px-3 py-2 text-sm font-medium text-black rounded-md bg-blue-500" : "px-3 py-2 text-sm font-medium text-white rounded-md bg-neutral-800 hover:bg-neutral-600"
